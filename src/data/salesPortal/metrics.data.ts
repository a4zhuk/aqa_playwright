...
import { IMertricsData } from "types/salesPortal/metrics.type";
...
export const testMetricsData: IMertricsData[] = [
  {
    ...
    data: {
      Metrics: {
        ...ordersMetric,
        orders: { ...ordersMetric.orders, totalOrders: 100 },
      },
      ErrorMessage: null,
      IsSuccess: true,
    },
    expected: "100",
    locator: "numberOfOrdersThisYear",
  },
  {
    ...
    expected: "50000",
    locator: "numberOfTotalCustomers",
  },
  {
    ...
    expected: "44444000",
    locator: "numberOfCanceledOrders",
  },
  {
    ...
    data: {
      Metrics: {
        ...ordersMetric,
        orders: { ...ordersMetric.orders, totalRevenue: 5500000 },
      },
      ErrorMessage: null,
      IsSuccess: true,
    },
    expected: "$" + numeral(5500000).format("0.0a"),
    locator: "sumOfTotalRevenue",
  },
  {
    ...
    data: {
      Metrics: {
        ...
        orders: {
          ...ordersMetric.orders,
          averageOrderValue: 12300000,
        },
      },
      ErrorMessage: null,
      IsSuccess: true,
    },
    expected: "$" + numeral(12300000).format("0.0a"),
    locator: "sumOfAvgOrdersValue",
  },
];
