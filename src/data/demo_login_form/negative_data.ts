...
const registrationInvalodData: IRegistrationData[] = [
    ...
    {
      testName: "Check registration using password that contains only lower case character",
      username: "TestUsername",
      password: "testpasword",
      message: "Password should contain at least one character in upper case"
    },
    {
      testName: "Check registration using password that contains only uppercase charactest",
      username: "TestUsername",
      password: "TESTPASSWORD",
      message: "Password should contain at least one character in lower case and one number"
    },
    {
      testName: "Check registration using pasword that contains only numbers",
      username: "TestUsername",
      password: "12345678",
      message: "Password should contain at least one character in lower and upper case"
    },
    {
